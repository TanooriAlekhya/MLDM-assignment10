# -*- coding: utf-8 -*-
"""Prem Chand 1700206C203 Assignment 8.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1bxlaqx1Di7OHSyQfJK-lFQ-zucJD3-8e
"""
...
"""From the above table we can say that [Attrition, BusinessTravel, Department, EducationField, Gender, JobRole, MaritalStatus, Over18, OverTime] are categorical variables.
...
"""Seems like there are no missing values in any of the variables in our dataset.
...
"""Before we proceed with find corelation among each and every variable lets drop those columns whose standard deviation is equal to 0."""
...
"""After implementing the Logistic Regression, the score obtained is 86.25% for this model and this dataset. From the confusion matrix we can say that there are 634 correct predictions and 101 wrong predictions.
Will implement the k-NN Algorithm on the same dataset and check with the results.
...
"""Implementation of Hyperparameter Tuning is made into another file which is named as "Lab8-2.ipynb".
...
"""As we can see from the above frequency distribution of the class variable we can declare that this dataset is purely imbalanced. And also the recall which signifies how true the calues are in a given prediction set is low to the '1' class variables. To tackle this I have made an implementation by oversampling the minority class in "Lab8-2.ipynb" file which also improves the accuracy and recall of our minority variable."""